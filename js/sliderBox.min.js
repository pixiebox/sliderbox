...
e()}function h(){g.responsive&&g.breakpoints.constructor===Array&&g.breakpoints.length?(p.setBreakpoint(b),r.push(b)):n(!1,function(){var c=a(".item",b),d=c.height(),e=b.width(),g=c.length*e;b.height(d);c.width(e);a(".placeholder",b).width(g)});b.on("click",".navigate",function(c){c.preventDefault();c=a(c.currentTarget).index();e("goto",c)});if(u)b.on("touchstart touchmove touchend",function(c){var a;if("undefined"!==typeof c&&"undefined"!==typeof c.originalEvent.touches)switch(a=c.originalEvent.touches[0],
